        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <a href="<?php echo site_url('admin/profil') ?>" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo site_url('admin/dashboard') ?>">MARKOST</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo site_url('admin/dashboard') ?>">MK</a>
          </div>
          <ul class="sidebar-menu">
              <li><a class="nav-link" href="<?php echo site_url('admin/dashboard') ?>"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
              <li><a class="nav-link" href="<?php echo site_url('admin/data_indekos') ?>"><i class="fas fa-pencil-ruler"></i> <span>Data Indekos</span></a></li>
              <li><a class="nav-link" href="<?php echo site_url('admin/data_user') ?>"><i class="fas fa-user"></i> <span>Data User</span></a></li>
            </ul>
        </aside>
      </div>